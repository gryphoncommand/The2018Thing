...
def dump_info():
    if hasattr(tankdrive, "encoders"):
        ...
        smartdashboard.putNumber("L Encoder Ticks", tankdrive.encoders["L"].get())
        smartdashboard.putNumber("R Encoder Ticks", tankdrive.encoders["R"].get())

    smartdashboard.putString("Gearing: ", tankdrive.get_gearing())
