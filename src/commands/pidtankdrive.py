...
class PIDTankDriveJoystick(Command):
    ...
    def __init__(self):
        ...
        self.pid["L"] = PIDController(pid.L[0], pid.L[1], pid.L[2], pid.L[3], self.l_src, subsystems.tankdrive.set_left)
        self.pid["R"] = PIDController(pid.R[0], pid.R[1], pid.R[2], pid.R[3], self.r_src, subsystems.tankdrive.set_right)
